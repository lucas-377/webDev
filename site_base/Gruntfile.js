...
module.exports = function (grunt) {
    ...
    purgecss: {
      dist: {
        options: {
          ...
          keyframes: true,
          fontFace: true,
          safelist: [/^slick-/, 'slick-dots li', 'slick-dots li button', 'header.active']
        },
        files: {
  ...
  // Task padrao.
  grunt.registerTask('dist', ['clean:all', 'sprite', 'copy:imagens', 'imagens', 'cwebp', 'copy:html', 'useminPrepare', 'dart-sass', 'webpcss', 'concat', 'purgecss', 'uglify:scripts', 'cssmin:main', 'usemin', 'clean:temp']);
};